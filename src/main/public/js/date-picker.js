const datePickerUtils = {
  ...
  displayFirstOfMonth: function(date) {
    ...
    if (day === "1") {
      const month = mDate.format("MMM");
        displayMonth.content = "<span aria-label=\"First of month \">"+ day +"</span><p class=\"first-of-month\">" + month + "</p>";
    } else {
       displayMonth.content = "<span tabindex=\"0\" aria-label="+ day + '' + month + ''+ year +"\>"+ day + "</span>";
